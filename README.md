# Unit testing using dotnet test sample From Microsoft
...
This is a personal Modification that I (benyamin) made, the real code is in https://github.com/dotnet/samples/tree/main/core/getting-started/unit-testing-using-dotnet-test/, as I use this as a playground using VS Code and C# DevTools. 
